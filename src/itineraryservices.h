...
public:
    ...
    void createItinerary(QString name, QString departure, QString departure_address, QString destination, QString destination_address, QString vehicle, QString favorite, ServicesBase::CallbackType callback);
    void editItinerary(int id, QString name, QString departure, QString departure_address, QString vehicle, QString favorite, ServicesBase::CallbackType callback);
...
public slots:
    ...
    void createItinerary(QString name, QString departure, QString departure_address, QString destination, QString destination_address, QString vehicle, QString favorite, QJSValue callback);
    void editItinerary(int id, QString name, QString departure, QString departure_address, QString vehicle, QString favorite, QJSValue callback);
